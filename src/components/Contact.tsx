...
const Contact: React.FC = () => {
  return (
    <section id="contact" className='block relative section_padding my-0 mx-0 box-border min-h-fit flex justify-center flex-col h-[40vh] lg:h-[70vh] w-full'>
      ...
      <div id="contact-info-upper-container" className='flex justify-center rounded-full border border-gray-400 sm:my-8 my-4 sm:p-2 p-1 sm:m-auto mr-2 ml-2 flex-wrap'>
